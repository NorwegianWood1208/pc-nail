export default {
  ...
  ecology : 'Pan-ecology  Blockchain Hatching Alliance',
  ...
  Github  : 'Real-time updating of  original code  data of  Github , NAIL business institute is built with offline communication club ( free of charge for possessing some certain quantities). NAIL hatching base , market value management team and multidimensionally build up the world class project.',
  supported  : 'First national supported digital assets project',
  ecol  : 'NAIL ecology entails investment & financing platform,  media publicity platform,  blockchain project hatching platform, exchange, business institute etc,. all these engagement of businesses will be conducted on the premise of multi-nation support, therefore, NAIL is the optimal choice.',
  ...
  sovereign : 'The 20  sovereign countries are respectively : Japan, Korea, Mongolia, the United States, Singapore, China, Malaysia, Canada, India, kyrgyzstan, Uzbekistan, kazakhstan, Russia, Buryatia, Indonesia, Vietnam, Thailand, Philippines, Azerbaijan, Belarus and the United Kingdom.',
  landmark  : '10 blockchain landmark architectures',
  follows  : 'The countries to build up blockchain landmarks are as follows: Japan, Korea, Mongolia, Singapore, China, Malaysia, Canada, kyrgyzstan, the United States and Russia.',
  ...
  than  : 'More than 10,000 users within 3 years  Covering 60 nations as the global top 3 virtual currencies',
